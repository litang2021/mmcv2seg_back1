...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=
        dict(type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.,class_weight=[0.1122, 0.9378, 0.8920, 1.7544, 0.5935, 1.7100]),
...
# load_from = "work_dirs/fpn_r50_b0w5/iter_4000.pth"
