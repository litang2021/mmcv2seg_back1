...
model = dict(
    ...
    decode_head=dict(
        ...
        dict(type='DiceLoss', loss_weight=.5)]
        ),
    train_cfg=dict(),
...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=int(1000 * 64 / batch_size), val_interval=100)
...
load_from = "work_dirs/fpn_r50_b0w1/iter_4000.pth"