...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=
        [dict(type='CrossEntropyLoss', use_sigmoid=False, loss_weight=.5, class_weight=[0.0001, 0.8063, 0.5268, 2.5095, 0.3216, 1.8357]),
        dict(type='DiceLoss', loss_weight=.5,class_weight=[0.0001, 1.2, 1.2, 1.2, 1.2, 1.1999])]
        ),
    train_cfg=dict(),
