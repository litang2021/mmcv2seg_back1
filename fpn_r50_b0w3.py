...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=
        [dict(type='CrossEntropyLoss', use_sigmoid=False, loss_weight=.5,class_weight=[0.2, 1.2, 1.2, 1.2, 1.2, 1.]),
        dict(type='DiceLoss', loss_weight=.5,class_weight=[0.2, 1.2, 1.2, 1.2, 1.2, 1.])]
        ),
    train_cfg=dict(),
