...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=
        dict(type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.,class_weight=[0.0094, 0.6561, 0.5936, 2.2964, 0.2628, 2.1816]),
        # dict(type='DiceLoss', loss_weight=.5,class_weight=[0.005, 0.8063, 0.5268, 2.5095, 0.3216, 1.8357])]
        ),
    train_cfg=dict(),
...
load_from = "work_dirs/fpn_r50_b0w12/iter_5000.pth"